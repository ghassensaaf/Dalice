			...
			<div class="row">
				...
				<div class="col-sm-3">
					<ul class="social-network">
						<li><a style="color: #b0b0b0;" class="" href="../fr/index.php" id="tip" data-toggle="popover" data-placement="right" title="français"><img width="15px" src="../img/lang/fr.png" alt="fr"></a></li>
						<li><a style="color: #b0b0b0;" class="" href="../en/index.php" id="tip" data-toggle="popover" data-placement="right" title="english"><img width="15px" src="../img/lang/en.png" alt="en"></a></li>
						<li><a style="color: #b0b0b0;" class="" href="../ar/index.php" id="tip" data-toggle="popover" data-placement="right" title="العربية"><img width="15px" src="../img/lang/ar.png" alt="ar"></a></li>
					</ul>
				</div>
				<div class="col-sm-9">
					<div class="row">
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a class="waves-effect waves-dark" href="contact.php">Contattaci
						</a></li>
                    </ul>
                </div>
            </div>
	    	...
	    	<div class="row">
					<div class="col-md-12">
						<div class="aligncenter">
							<h2 class="aligncenter">Attività</h2>
						</div>
						<br/>
					</div>
				</div>
