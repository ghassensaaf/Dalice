...
<div id="wrapper">
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse ">
					<ul class="nav navbar-nav">
						<li ><a class="waves-effect waves-dark" href="index.php">Acceuil</a></li>
						<li class="active"><a class="waves-effect waves-dark" href="contact.php">Contactez nous</a></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<section id="inner-headline">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h2 class="pageTitle">Contactez nous</h2>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="about-logo">
						<h3>Nous<span class="color"> contacter</span></h3>
						<p>	Soyez international avec Dalice International Trading Company <br>
							Pour de plus amples informations, veuillez nous contacter :
						</p>
						<div style="margin-top: 50px" class="container ">
							<div class="row">
								<div class="col-md-2"><p style="color: #ce292c"><span class="iconify" data-icon="mdi-phone" data-inline="true"></span><b> téléphone</b></p></div>
				...
				<div class="col-md-12">
					<form role="form" name="sentMessage" id="contactForm" class="contact-form" data-toggle="validator" class="shake">
						<div class="form-group input-field">
							<div class="controls ">
								<input type="text" id="name" class="form-control"  minlength="4" required data-error="Veuillez  saisir nom ">
						...
						<div class="form-group">
							<div class="controls input-field">
								<input type="email" class="email form-control" id="email" required data-error="Veuillez  saisir votre prenom">
						...
						<div class="form-group">
							<div class="controls input-field">
								<input type="text" id="msg_subject" class="form-control"  minlength="6" required data-error="Veuillez saisir le sujet de votre message (6 caractères min)">
								<label for="msg_subject" class="">   Sujet </label>
								<div class="help-block with-errors"></div>
							</div>
						</div>
						<div class="form-group">
							<div class="controls input-field">
								<textarea id="message" rows="7" class="form-control materialize-textarea" minlength="20" required data-error="Veuillez saisir votre message (20 caractères au minimum)"></textarea>
								<label for="message" class="">   Message </label>
								<div class="help-block with-errors"></div>
							</div>
						</div>

						<button type="submit" id="submit" class="btn btn-success"></i> Envoyer</button>
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="widget">
						...
						<ul class="link-list">
							<li><a class="waves-effect waves-dark" href="index.php">Acceuil</a></li>
							<li><a class="waves-effect waves-dark" href="contact.php">Contactez nous</a></li>
						</ul>
					</div>
					<div class="">
						<ul class="social-network">
